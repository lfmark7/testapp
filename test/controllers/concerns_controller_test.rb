...
class ConcernsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concern" do
    assert_difference('Concern.count') do
      post concerns_url, params: { concern: { content: @concern.content, user_id: @concern.user_id } }
    end
  ...
  test "should update concern" do
    patch concern_url(@concern), params: { concern: { content: @concern.content, user_id: @concern.user_id } }
